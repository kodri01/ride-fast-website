    ...
    <div class="section-content2 ">
        <nav style="--bs-breadcrumb-divider: '>'; margin-left:80px;" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Produk Perawatan</li>
            </ol>
        </nav>
        <center>
            <h2 class="text-capitalize">items <b style="color: #1A51BD">Perawatan</b></h2>
            <div class="line"></div>
        </center>
        <div class="galery">
            <div class="row mb-4">
                <div class="row ">
                    <?php
                    $sql = "SELECT * FROM product where category = 'Perawatan'";
                    ...
                    <div class='alert alert-warning' role='alert'>
                        <b>Product Perawatan Tidak Tersedia</b>
                      </div>
                    </center>";
                    }
                    ?>
